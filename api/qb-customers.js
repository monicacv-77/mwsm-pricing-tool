...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const query = `SELECT * FROM Customer WHERE DisplayName LIKE '%${search}%' MAXRESULTS 10`;
    const url = `${QB_BASE}/v3/company/${REALM_ID}/query?query=${encodeURIComponent(query)}&minorversion=65`;
    ...
    console.error("QB customers error:", err.message);
